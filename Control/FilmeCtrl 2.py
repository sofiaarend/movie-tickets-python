...
class FilmeCtrl(object):
    ...
    def cadastroFilme(self, codfilme, Form, list_usu, list_gen, list_venda, codcli):
        ...
        if (not nome) or (not duracao):
            ...
            if codfilme == 0:
                ...
                if success == 1:
                    ...
                    msg.setStandardButtons(QMessageBox.Ok)
                    msg.exec_()
                    FilmeCtrl.abreLista(list_usu, list_gen, list_venda, Form)
                else:
                    msg = QMessageBox()
                    msg.setIcon(QMessageBox.Information)
                ...
                if success == 1:
                    ...
                    msg.setStandardButtons(QMessageBox.Ok)
                    msg.exec_()   
                    FilmeCtrl.abreLista(codcli, list_usu, list_gen, list_venda, Form)
                else: 
                    msg = QMessageBox()
                    msg.setIcon(QMessageBox.Information)
    ...
    def abreLista(codfilme, list_usu, list_gen, list_venda, Form):
        self.listFilme = QtWidgets.QMainWindow()
        self.ui = main
        self.ui.setupUi(self.listFilme, codfilme, list_usu, list_gen, list_venda)
        self.listFilme.show()
        Form.close()
